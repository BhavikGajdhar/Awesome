...
(async () => {
  const URL = `${Constants.API_URL}/restaurants/list/v5?lat=20.5992349&lng=72.9342451&collection=${collectionId}&tags=layout_ux4&sortBy=&filters=&type=rcv2&offset=0&page_type=null`;
    ...
    .map((restaurant) => {
      if (data.data.cards.indexOf(restaurant) > 2) {
        return ` <a
          ...
          href="./restaurantpage.html?restaurantId=${restaurant.card.card.info
            .id}"
        >
          <div class="restaurant-card">
            <figure class="restaurant-card-image">
              <img
                ...
                src="${Constants.IMAGE_URL}/${restaurant.card.card.info
                  .cloudinaryImageId}"
              />
              alt="" />
            </figure>
